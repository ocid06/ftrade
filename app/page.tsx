...
<div className="mb-12 lg:mb-0 lg:mt-6">
  ...
  <div className="grid grid-cols-2 gap-4 lg:items-center">
    <div className="cta-button">
      <a
        ...
        className="flex min-h-[68px] w-full items-center justify-center rounded-2xl bg-gradient-to-r from-[#2F5BFF] to-[#3C66F5] px-6 py-4 text-center text-base font-semibold leading-none tracking-[-0.01em] text-white shadow-[0_10px_26px_-18px_rgba(47,91,255,0.9)]"
      >
    ...
    <div className="cta-button">
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex min-h-[68px] w-full items-center justify-center rounded-2xl border-2 border-[#2F5BFF] bg-white/60 px-6 py-4 text-center text-base font-semibold leading-none tracking-[-0.01em] text-[#2F5BFF] shadow-[0_10px_26px_-18px_rgba(47,91,255,0.7)]"
      >
  ...
  <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4">
    ...
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="card-3d-soft group flex min-h-[84px] items-center gap-3 rounded-2xl border border-[#DCE8FF] bg-white/75 px-4 py-3 shadow-[0_12px_28px_-22px_rgba(47,91,255,0.75)] backdrop-blur-md transition hover:-translate-y-0.5 hover:border-[#BFD3FF] hover:bg-white"
    >
<div className="relative h-11 w-11 shrink-0 overflow-hidden rounded-full border border-[#DCE8FF] bg-white">
  <Image
    src="/ftrade-community.jpg"
    alt="FTRADE Official Community"
    fill
    className="object-cover"
  />
</div>
      <div className="min-w-0">
        <p className="text-[9px] font-bold uppercase tracking-[0.15em] text-[#2F5BFF]">
          Community
        </p>
    ...
    {/* WHATSAPP BA */}
    <a
      href="https://wa.me/6287727837744"
      target="_blank"
      rel="noopener noreferrer"
      className="card-3d-soft group flex min-h-[84px] items-center gap-3 rounded-2xl border border-[#DCE8FF] bg-white/75 px-4 py-3 shadow-[0_12px_28px_-22px_rgba(47,91,255,0.75)] backdrop-blur-md transition hover:-translate-y-0.5 hover:border-[#BFD3FF] hover:bg-white"
    >
      <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[#EEF3FF] text-[#2F5BFF]">
        <svg
          viewBox="0 0 24 24"
          fill="none"
          className="h-5 w-5"
      ...
      <div className="min-w-0">
        ...
        <p className="mt-1 text-[10px] leading-tight text-gray-500">
          If Customer Support has not responded
        </p>
      </div>
    </a>
  </div>
...
<div className="hidden lg:block">              <div className="premium-card-shell group rounded-[28px] border border-white/45 bg-[linear-gradient(180deg,rgba(255,255,255,0.62),rgba(237,244,255,0.72))] p-5 shadow-[0_24px_60px_-36px_rgba(47,91,255,0.72)] backdrop-blur-xl">
  ...
  key={idx}
  onClick={() => {
    if (broker.registerOptions && broker.registerOptions.length > 0) {
      setSelectedRegisterBroker(broker);
      return;
    }

    if (broker.ibLink) {
      window.open(broker.ibLink, '_blank', 'noopener,noreferrer');
    }
  }}
...
{isMounted &&
  ...
  createPortal(
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label={`Register ${selectedRegisterBroker.name}`}
    >
      <div
      ...
      >
        <button
          type="button"
          onClick={() => setSelectedRegisterBroker(null)}
          className="absolute right-5 top-5 flex h-9 w-9 cursor-pointer items-center justify-center rounded-full bg-gray-100 text-gray-500 transition hover:bg-gray-200 hover:text-gray-900"
          aria-label="Close"
        >
          ×
        </button>
